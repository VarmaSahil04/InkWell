...
import { registerRoute, startRouter } from './router.js?v=1.0.5';
import { renderLogin } from './views/login.js?v=1.0.5';
import { renderSignup } from './views/signup.js?v=1.0.5';
import { renderForgotPassword } from './views/forgot-password.js?v=1.0.5';
import { renderResetPassword } from './views/reset-password.js?v=1.0.5';
import { renderDashboard } from './views/dashboard.js?v=1.0.5';
import { renderEditor } from './views/editor.js?v=1.0.5';
import { renderEntryDetail } from './views/entry-detail.js?v=1.0.5';
import { renderProfile } from './views/profile.js?v=1.0.5';
import { renderAdmin } from './views/admin.js?v=1.0.5';
